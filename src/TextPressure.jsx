...
const TextPressure = ({
  ...
  useEffect(() => {
    if (isPerformanceMode) return undefined;
    ...
    if (containerRef.current) {
      const { left, top, width: rectW, height } = containerRef.current.getBoundingClientRect();
  ...
  }, [width, weight, italic, alpha, isPerformanceMode]);
